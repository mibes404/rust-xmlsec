...
#[allow(missing_docs)]
#[repr(u32)]
pub enum XmlSecKeyDataType {
    Unknown = bindings::xmlSecKeyDataTypeUnknown,
    Any = bindings::xmlSecKeyDataTypeAny,
    Permanent = bindings::xmlSecKeyDataTypePermanent,
    Private = bindings::xmlSecKeyDataTypePrivate,
    Public = bindings::xmlSecKeyDataTypePublic,
    Session = bindings::xmlSecKeyDataTypeSession,
    Symmetric = bindings::xmlSecKeyDataTypeSymmetric,
    Trusted = bindings::xmlSecKeyDataTypeTrusted,
}
...
impl XmlSecKey {
    ...
    pub fn load_cert_from_file(&self, path: &str, format: XmlSecKeyFormat) -> XmlSecResult<()> {
        ...
        let rc =
            unsafe { bindings::xmlSecOpenSSLAppKeyCertLoad(self.0, cpath.as_ptr(), format as u32) };
